...
export type TaskClarificationResponseType = {
  _id: string;
  question: string;
  askedBy: {
    _id: string;
...
export type TaskClarificationListResponseType = {
  message: string;
  clarifications: TaskClarificationResponseType[];
};

export type CreateTaskClarificationPayloadType = {
  workspaceId: string;
  taskId: string;
  question: string;
};

export type RespondTaskClarificationPayloadType = {
  workspaceId: string;
  taskId: string;
